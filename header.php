    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="home.php" class="logo  ">
                ...
                <span class="logo-lg " style="border-radius : 7px">
                    <h3>SingalApp</h3>
                </span>
            </a>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="subcategories.php">
                        <i class="fa fa-object-group "></i> <span>Sub Categories</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="#">
                        ...
                        if ($count) { ?>
                            <span class="label label-info pull-right"><?php echo $count; ?></span>
                        <?php    } ?>
                    </a>
                    <ul class="treeview-menu">
