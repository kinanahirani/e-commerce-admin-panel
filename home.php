...
<body>
    ...
    <div class="content-wrapper">
        ...
        <h2>HOME</h2>
            <ol class="breadcrumb">
                <li>
                   <h2> <a href="home.php"> <i class="fa fa-home"></i> Home</a></h2>
                </li>
            </ol>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-6 col-xs-6 ">
                    <div class="alert alert-info alert-dismissible"  style="border-radius : 7px">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="box box-warning"  style="border-radius : 7px">
                        <?php $year = date("Y");
                        $curdate = date('Y-m-d');
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-primary" style="border-radius :7px">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-warning" style="border-radius : 7px">
                            ...
                            <div class="box-footer clearfix" style="border-radius : 7px">
