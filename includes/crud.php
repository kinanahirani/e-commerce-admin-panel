...
define('DOMAIN_URL', 'http://localhost/Multivendor%20%20rcodeinfotech.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', '9773126516_rcodeinfotech_jamnagar'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_host = "localhost:3360";  // Change as required
