                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id='pincode_id' name="pincode_id" class='form-control'>
                                            ...
                                            <?php foreach ($pincodes as $row) { ?>
                                                <option value='<?= $row['id'] ?>'><?= $row['pincode'] . " " . $row['city'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="status" class="btn-group">
                                            <label class="btn btn-default" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="require_products_approval" value="0" checked> Yes
                                            </label>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div id="status" class="btn-group">
                                            ...
                                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="status" value="1" checked> Approoved
                                            </label>
                                            <label class="btn btn-danger" data-toggle-class="btn-danger" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="status" value="2"> Not-Approoved
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div id="customer_privacy" class="btn-group">
                                            ...
                                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="customer_privacy" value="0" checked> No
                                            </label>
                                        </div>
                                    </div>
                                </div>
