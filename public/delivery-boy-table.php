                        ...
                        <div class="row">
                            <div class=" col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name='pincode_id[]' id='pincode_id' class='form-control' required placeholder='Enter the city you want to allow delivery this delivery boy' multiple="multiple">
                            ...
                            <div class="row">
                                <div class=" col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name='update_pincode_id[]' id='update_pincode_id' class='form-control'  required placeholder='Enter the city you want to allow delivery this delivery boy' multiple="multiple">
                                            <?php
                                            $sql = 'select id,pincode,city from `pincodes` where `status` = 1 order by id desc';
                                            $db->sql($sql);
                                            $result = $db->getResult();
                                            foreach ($result as $value) {
                                            ?>
