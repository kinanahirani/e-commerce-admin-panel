...
if (isset($_POST['btnEdit'])) {
    ...
    if ($permissions['locations']['update'] == 1) {
        ...
        if (!empty($pincode) && !empty($city) && $status != "") {
            $sql_query = "UPDATE pincodes SET pincode = '$pincode' , city = '$city',`status`=$status WHERE id = $ID";
            $db->sql($sql_query);
                ...
                <form method="post" id="edit_form" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city" required value="<?= $res[0]['city']; ?>" />
                        </div>
                        <div class="form-group">
