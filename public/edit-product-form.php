                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="product_pincodes" id="product_pincodes" class="form-control" required>
                                                    ...
                                                    <option value="included" <?= (!empty($res[0]['d_type']) && $res[0]['d_type'] == "included") ? 'selected' : ''; ?>>City Included</option>
                                                    <option value="excluded" <?= (!empty($res[0]['d_type']) && $res[0]['d_type'] == "excluded") ? 'selected' : ''; ?>>City Excluded</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name='pincode_ids_exc[]' id='pincode_ids_exc' class='form-control' placeholder='Enter the city you want to allow delivery this product' multiple="multiple">
                                                    <?php $sql = 'select id,pincode,city from `pincodes` where `status` = 1 order by id desc';
                                                    $db->sql($sql);
                                                    $result = $db->getResult();
                                                    if ($res[0]['pincodes'] != "") {
                                                        foreach ($result as $value) {
                                                    ?>
                                                            <option value='<?= $value['id'] ?>' <?= (strpos(" " . $res[0]['pincodes'], $value['id'])) ? 'selected' : ''; ?>><?= $value['pincode'] . " " . $value['city'] ?></option>
                                                        <?php }
                                                    } else {
                                                        foreach ($result as $value) { ?>
                                                            <option value='<?= $value['id'] ?>'><?= $value['pincode'] . " " . $value['city'] ?></option>
