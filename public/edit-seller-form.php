                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id='pincode_id' name="pincode_id" class='form-control'>
                                            ...
                                            <?php foreach ($pincodes as $row) { ?>
                                                <option value='<?= $row['id'] ?>' <?= ($res[0]['pincode_id'] == $row['id']) ? 'selected' : ''; ?>><?= $row['pincode'] . " - " . $row['city'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div id="status" class="btn-group">
                                            ...
                                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="status" value="1" <?= ($res[0]['status'] == 1) ? 'checked' : ''; ?>> Approoved
                                            </label>
                                            <label class="btn btn-danger" data-toggle-class="btn-danger" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="status" value="2" <?= ($res[0]['status'] == 2) ? 'checked' : ''; ?>> Not-Approoved
                                            </label>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
 CKEDITOR.replace('description123456');
</script>
<script>
    $('#edit_form').validate({
        rules: {
    ...
    $('#edit_form').on('submit', function(e) {
        e.preventDefault();
        var content = CKEDITOR.instances['description123456'].getData();
