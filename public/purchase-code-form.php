<section class="content-header">
    <h1>rcodeinfotech Purchase Code <a href='purchase-code.php'></h1> 
    <ol class="breadcrumb">
                ...
                <div class="box-body">
                    <form id="validate_code_form" method="GET">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Enter the Purchase Code shared by the customer for rcodeinfotech</label>
